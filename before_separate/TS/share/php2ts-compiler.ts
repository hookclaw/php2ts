...
namespace compiler {
    // export type TypeDefine = {importname:string,varname:string,modulepath:string};
    // export type TypeMaping = {[key:string]:TypeDefine};
    // export type TypeMaper = {const:TypeMaping,class:TypeMaping,function:TypeMaping};
    ...
    export module pass1 {
        ...
        // export let pass1 = (ast:baseAst,relativePath:string):spa => {
        //     let spa:spa = {relativePath,namespace:[],
        //         use:[],const:[],class:[],function:[],return:false};
        //     pass1main(ast,spa);
        //     return spa;
        ...
        let pass1main = (someAst:baseAst|baseAst[],spa:spa) => {
            ...
            switch(_const.getLocalKind(ast.kind)) {
                ...
                case _const.AST.CONST_ELEM:
                    pass1_CONST(ast,spa);
                    break;
                // case _const.AST.INCLUDE_OR_EVAL:
                //     pass1_INCLUDE(ast,spa);
                //     break;
        ...
        // let pass1_INCLUDE = (ast:baseAst,spa:spa) => {
        //     let namespace = expandNamespace(spa.namespace);
        //     let flags = ast.flags;
        //     let expr = ast.children[_const.CHILD_EXPR];
        //     spa.include.push({flags,expr,namespace});
        // }
